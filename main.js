/* ════════════════════════════════════════════
   CONFIG
════════════════════════════════════════════ */
const RESERVA_URL = "https://estudiotango.com/turnos2.html";
...
function renderizar(json) {
  ...
  html += '<section class="cta-urgencia ' + diagClass + ' anim-in cta-urgencia-desktop" style="animation-delay:.09s" aria-label="Próximos pasos">'
    ...
    + '<button class="btn-reservar" onclick="reservarTurno()" aria-label="Sacar turno gratuito con asesor">'
    + '<span class="btn-reservar-label">Sacar turno gratuito con un asesor</span>'
    + '<span class="btn-reservar-meta">Sin costo · 30 min · Videollamada o llamada</span>'
    + '</button>'
    + '<a href="https://wa.me/5493435020970?text=Hola%2C%20acabo%20de%20ver%20mi%20informe%20del%20BCRA%20y%20quiero%20saber%20si%20puedo%20eliminar%20mis%20deudas%20del%20Veraz" target="_blank" rel="noopener" style="display:flex;align-items:center;justify-content:center;gap:9px;background:#25D366;color:#fff;border-radius:10px;padding:14px 20px;font-size:.9rem;font-weight:600;text-decoration:none;text-align:center;transition:background .2s">'
    ...
    + 'Hablar ahora con un asesor por WhatsApp'
    + '</a>'
    + '</div>'
    + '</section>';
  ...
  html += '<section class="cta-card anim-in cta-card-desktop" style="animation-delay:.3s" aria-label="Próximos pasos">'
    + '<p>Ya sabés lo que figura en el BCRA. El siguiente paso es saber si podés eliminarlo — y en cuánto tiempo. Eso es exactamente lo que resolvemos en <strong>30 minutos</strong>, sin costo.</p>'
    + '<div class="cta-btns">'
    + '<button class="btn-primary" onclick="reservarTurno()">Sacar turno gratuito con un asesor</button>'
    + '<a href="https://wa.me/5493435020970?text=Hola%2C%20acabo%20de%20ver%20mi%20informe%20del%20BCRA%20y%20quiero%20saber%20si%20puedo%20eliminar%20mis%20deudas%20del%20Veraz" target="_blank" rel="noopener" class="btn-secondary-link">O escribinos por WhatsApp ahora</a>'
    + '</div>'
    + '<p class="cta-note">Sin gastos iniciales · Consulta gratuita · Préstamos hasta $6.000.000 post-saneamiento</p>'
...
function chatInitMessages() {
  ...
  chatAppend("bot", "Hola 👋 Soy el asistente de <strong>TANGO</strong>. Si tenés deudas que podrían eliminarse por la Ley 25.326 o querés entender qué figura en tu BCRA, estoy acá para orientarte. También puedo explicarte cómo funciona el proceso — sin costo, sin compromisos. ¿Por dónde arrancamos?");
  ...
  var opciones = [
    "¿Puedo eliminar mis deudas del Veraz?",
    "¿Qué es la Ley 25.326 y cómo aplica?",
    "¿Cuánto cuesta y cómo funciona el servicio?",
    "¿Qué significa lo que aparece en mi BCRA?"
  ];
  ...
  waLink.className = "chat-sugg-btn chat-sugg-wa";
  waLink.href      = "https://wa.me/5493435020970?text=Hola%2C%20quiero%20saber%20si%20puedo%20eliminar%20mis%20deudas%20del%20Veraz";
  waLink.target    = "_blank";
  waLink.rel       = "noopener";
  waLink.innerHTML =
    '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="width:16px;height:16px;fill:#25D366;flex-shrink:0;">'
    + '<path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>'
    + '</svg>'
    + ' Hablar con un asesor humano';
  sugg.appendChild(waLink);
...
function chatAppend(role, html, showCta) {
  ...
  if (showCta) {
    ...
    cta.innerHTML =
      '<p>Si tus deudas tienen más de 5 años, la Ley 25.326 puede habilitarte a eliminarlas del Veraz. '
      + 'En 30 minutos un asesor revisa tu caso, sin costo y sin compromisos. '
      + 'También podés escribirnos directamente por WhatsApp.</p>'
      + '<a href="' + (typeof RESERVA_URL !== "undefined" ? RESERVA_URL : "#") + '" class="chat-cta-btn" target="_blank" rel="noopener">'
      + '📅 Sacar turno gratuito con un asesor'
      + '</a>'
      + '<a href="https://wa.me/5493435020970?text=Hola%2C%20quiero%20saber%20si%20puedo%20eliminar%20mis%20deudas%20del%20Veraz" target="_blank" rel="noopener" class="chat-cta-btn" style="background:#25D366;margin-top:6px">'
      + '💬 Hablar por WhatsApp ahora'
      + '</a>'
      + '<p class="chat-cta-note">Sin gastos iniciales · Préstamos hasta $6.000.000 post-saneamiento</p>';
